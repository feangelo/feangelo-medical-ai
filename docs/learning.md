...
The canonical lesson files remain in the repository's `learning/3d-slicer/` directory. This avoids maintaining duplicate copies while keeping the public site focused and sustainable.

| Record | Topic |
|---|---|
| [Lesson 01](https://github.com/feangelo/feangelo-medical-ai/blob/main/learning/3d-slicer/lesson-01-introduction-to-3d-slicer.md) | Introduction to 3D Slicer |
| [Lesson 02](https://github.com/feangelo/feangelo-medical-ai/blob/main/learning/3d-slicer/lesson-02-first-lung-segmentation.md) | First lung segmentation |
| [Lesson 03](https://github.com/feangelo/feangelo-medical-ai/blob/main/learning/3d-slicer/lesson-03-segmentation-pipeline.md) | Segmentation pipeline |
| [Lesson 04](https://github.com/feangelo/feangelo-medical-ai/blob/main/learning/3d-slicer/lesson-04-quality-control-and-manual-editing.md) | Quality control and manual editing |
| [Lesson 05](https://github.com/feangelo/feangelo-medical-ai/blob/main/learning/3d-slicer/lesson-05-segmentation-validation-and-quality-metrics.md) | Segmentation validation and quality metrics |
| [Lesson 06](https://github.com/feangelo/feangelo-medical-ai/blob/main/learning/3d-slicer/lesson-06-observer-variability-and-scientific-reproducibility.md) | Observer variability and reproducibility |
| [Lesson 07](https://github.com/feangelo/feangelo-medical-ai/blob/main/learning/3d-slicer/lesson-07-image-acquisition-and-protocol-standardization.md) | Image acquisition and protocol standardization |
| [Lesson 08](https://github.com/feangelo/feangelo-medical-ai/blob/main/learning/3d-slicer/lesson-08-image-preprocessing-and-harmonization.md) | Image preprocessing and harmonization |
